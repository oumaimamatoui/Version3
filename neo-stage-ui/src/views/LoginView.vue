      ...
      <div class="bento-login-card animate__animated animate__fadeInUp">
        ...
        <Transition name="fade-slide" mode="out-in">
          ...
          <div v-if="requestSent" class="success-portal" key="success">
            ...
            <h3 class="success-title">Accès Autorisé</h3>
            <p class="success-sub">Identité vérifiée avec succès.<br>Initialisation de votre terminal personnel...</p>
...
/* ✅ SUCCESS AMÉLIORÉ */
.success-portal { text-align: center; padding: 30px 0 10px; }
...
.pulse-ring-inner {
  ...
  border-radius: 50%;
  background: #fef3c7;
  animation: pulseOut 2s ease-out infinite 0.35s;
}
...
.success-icon-core {
  ...
  animation: popIn 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.8);
}
...
.success-dots span:nth-child(2) { animation-delay: 0.2s; background: #fcd34d; }
.success-dots span:nth-child(3) { animation-delay: 0.4s; background: #fde68a; }
