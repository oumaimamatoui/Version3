...
// ── AJOUT ── Vue détail candidat (page /analyse-comportementale/:id)
import CandidateDetailsView from '../views/CandidateDetails.vue'
...
import DetailsCandidatView from '../views/CandidateDetails.vue'
...
import SuperAdminStatistque from '../views/SuperAdminStatistque.vue'
...
const routes = [
  ...
  // ── AJOUT : Détail d'un candidat — c'est cette route qui manquait (404) ──────
  {
    path: '/analyse-comportementale/:id',
    name: 'analyse-comportementale-detail',
    component: CandidateDetailsView,
    meta: { requiresAuth: true, permission: 'view_tests' },
  },
