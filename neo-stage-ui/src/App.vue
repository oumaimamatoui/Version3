...
const applyThemeForCurrentRoute = () => {
  // 1. Lire la préférence (si l'utilisateur est connecté) ou utiliser la clé locale globale (pour les invités)
  ...
  // 2. Définir le thème (par défaut "light" s'il n'y a rien)
  const savedTheme = dbTheme || localTheme || 'light';
  
  // 3. Appliquer le thème partout (pages publiques ET privées)
