      ...
      <nav class="sb-nav">
        ...
        <div v-if="roleUtilisateur === 'SuperAdmin'" class="sb-sections">
          <div class="sb-groupe">
            ...
            <router-link to="/super-admin-analytics" class="sb-lien">
              <span class="sb-lien-icone ic-violet"><i class="fa-solid fa-chart-simple"></i></span>
              <span class="sb-lien-texte">{{ t('sidebar.links.analyticsView') }}</span>
            </router-link>
          </div>
        </div>
...
const libelleRole = computed(() => {
  ...
  return cleRole ? t(`roles.${cleRole}`) : 'Utilisateur';
});
