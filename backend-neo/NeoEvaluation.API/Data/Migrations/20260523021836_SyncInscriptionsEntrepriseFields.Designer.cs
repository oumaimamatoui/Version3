...
namespace NeoEvaluation.API.Data.Migrations
{
    ...
    [Migration("20260523021836_SyncInscriptionsEntrepriseFields")]
    partial class SyncInscriptionsEntrepriseFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeoEvaluation.API.Models.Categorie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NeoEvaluation.API.Models.Entreprise", b =>
                {
                    ...
                    b.Property<DateTime?>("AbonnementDebut")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NeoEvaluation.API.Models.Evaluation", b =>
                {
                    ...
                    b.Property<int>("InfractionsCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NeoEvaluation.API.Models.SousCategorie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NeoEvaluation.API.Models.SousCategorie", b =>
                {
                    b.HasOne("NeoEvaluation.API.Models.Categorie", "Categorie")
